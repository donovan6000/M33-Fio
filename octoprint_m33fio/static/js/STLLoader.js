...
THREE.STLLoader.prototype.parseBinary = function ( data ) {
	...
	for ( var i = 0; i < triangles; i++ ) {
		...
		for ( var j = 0; j < 3; j++, offset += 12 ) {
		
			geometry.vertices.push( new THREE.Vector3( reader.getFloat32( offset, true ), reader.getFloat32( offset + 4, true ), reader.getFloat32( offset + 8, true ) ) );
